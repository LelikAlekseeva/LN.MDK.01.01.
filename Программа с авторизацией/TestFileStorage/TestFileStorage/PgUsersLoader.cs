...
namespace TestFileStorage
{
    ...
    {
        private const string ConnectSetting = "Host=192.168.1.48,Username=st56-2,Password=562;Users_P-30";
        ...
        public bool UserVerification(string login)
        {
            ...
            var con = new NpgsqlConnection(ConnectSetting);
            con.Open();
            var sql = "select exisrs (select 1 from outusers WHERE login = 'emily_brown')";
            var cmd = new NpgsqlCommand(sql, con);
